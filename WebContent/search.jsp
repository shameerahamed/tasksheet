...
<table class="tablesorter" cellpadding="5" cellspacing="1"  id="main" width="100%">	
	...
	<logic:iterate id="taskHolderId" indexId="indx"	type="com.task.TaskSheetHolder" property="taskList"	name="taskSheetForm" length="${taskSheetForm.offset}" offset="${(taskSheetForm.pageNo-1)*taskSheetForm.offset}">				
              <tr>
		    	<logic:notPresent parameter="reportTask">
